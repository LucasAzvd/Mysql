...
SET SQL_SAFE_UPDATES = 0; -- Desativando os Safe Update (Medida padrão de precaução, que proibe a atualização de todas as linhas da tabela) do SQL
...
-- apelidos
SELECT * FROM funcionarios f WHERE funcionarios.salario > 2000;
